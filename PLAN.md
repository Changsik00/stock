...
| # | 작업 | 내용 | 완료 기준 |
|---|---|---|---|
| 5.8-1 | 소스 + 수집 | `clients/us_indices.py` + `collectors/macro.py` 4개 시리즈 추가 | 매크로 배치 실행 시 macro_series에 4개 시리즈 upsert |
| 5.8-2 | 프런트 타일 | 시황·자금 행에 4개 KpiTile 추가 + 상세 모달 | 대시보드에 전일 미국장 4개 지수 표시, 날짜 배지 정상 |
