...
| # | 작업 | 내용 | 완료 기준 |
|---|---|---|---|
| 5.13-1 | 백엔드 | `record_breadth_snapshot`/`get_breadth_series` + 라우트, live_refresh 60초 잡 배선 | 장중 60초마다 상승비율 한 점씩 실제로 쌓임 |
| 5.13-2 | 프런트 | BreadthModal에 1D 라인차트 + 50% 기준선 | 시간순 상승비율 추이가 50% 선 기준으로 보임 |
